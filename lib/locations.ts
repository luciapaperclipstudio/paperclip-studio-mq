...
export const locations: LocationPage[] = [
  {
    ...
    metaTitle: 'Web Designer Cape Town | AI-Powered Websites from R1,800',
    metaDescription:
      'Professional AI-powered websites for Cape Town businesses. Mobile-first, SEO-optimised, and delivered in 3–7 days. Packages from R1,800.',
  },
  {
    ...
    metaTitle: 'Web Designer Johannesburg | AI Websites from R1,800',
    metaDescription:
      'AI-powered websites for Johannesburg businesses. Fast turnaround, honest pricing, built to convert. Packages from R1,800.',
  },
  {
    ...
    servicesIntro:
      'Simple, well-priced packages for Durban businesses — from the beachfront to Umhlanga — with a professional site delivered in days, not months.',
    cityBlurb:
    ...
    metaTitle: 'Web Designer Durban | AI Websites from R1,800',
    metaDescription:
      'Professional AI-powered websites for Durban businesses. Mobile-ready, SEO-optimised, delivered in 3–7 days. From R1,800.',
  },
]
